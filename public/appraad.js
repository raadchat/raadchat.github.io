    ...
    /*    if (top != self) {
        ...
        function hashFingerprintString(inputData) {
            ...
            for (var blockIndex = 0; blockIndex < wordsArray.length; blockIndex += 16) {
                ...
                // ==========================================
                state_A = md5_F(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 0], 0x7, 0xd76aa478);
                state_D = md5_F(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 1], 0xc, 0xe8c7b756);
                state_C = md5_F(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 2], 0x11, 0x242070db);
                state_B = md5_F(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 3], 0x16, 0xc1bdceee);
                state_A = md5_F(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 4], 0x7, 0xf57c0faf);
                state_D = md5_F(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 5], 0xc, 0x4787c62a);
                state_C = md5_F(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 6], 0x11, 0xa8304613);
                state_B = md5_F(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 0x7], 0x16, 0xfd469501);
                state_A = md5_F(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 0x8], 0x7, 0x698098d8);
                state_D = md5_F(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 0x9], 0xc, 0x8b44f7af);
                state_C = md5_F(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 10], 0x11, 0xffff5bb1);
                state_B = md5_F(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 0xb], 0x16, 0x895cd7be);
                state_A = md5_F(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 0xc], 0x7, 0x6b901122);
                state_D = md5_F(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 0xd], 0xc, 0xfd987193);
                state_C = md5_F(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 0xe], 0x11, 0xa679438e);
                state_B = md5_F(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 15], 0x16, 0x49b40821);

                // ==========================================
                // المرحلة الثانية: تنفيذ دالة المعالجة md5_G (Round 2)
                // ==========================================
                state_A = md5_G(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 1], 5, 0xf61e2562);
                state_D = md5_G(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 6], 0x9, 0xc040b340);
                state_C = md5_G(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 0xb], 0xe, 0x265e5a51);
                state_B = md5_G(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 0], 0x14, 0xe9b6c7aa);
                state_A = md5_G(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 5], 5, 0xd62f105d);
                state_D = md5_G(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 10], 0x9, 0x2441453);
                state_C = md5_G(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 15], 0xe, 0xd8a1e681);
                state_B = md5_G(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 4], 0x14, 0xe7d3fbc8);
                state_A = md5_G(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 0x9], 5, 0x21e1cde6);
                state_D = md5_G(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 0xe], 0x9, 0xc33707d6);
                state_C = md5_G(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 3], 0xe, 0xf4d50d87);
                state_B = md5_G(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 0x8], 0x14, 0x455a14ed);
                state_A = md5_G(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 0xd], 5, 0xa9e3e905);
                state_D = md5_G(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 2], 0x9, 0xfcefa3f8);
                state_C = md5_G(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 0x7], 0xe, 0x676f02d9);
                state_B = md5_G(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 0xc], 0x14, 0x8d2a4c8a);

                // ==========================================
                // المرحلة الثالثة: بدء تنفيذ دالة المعالجة md5_H (Round 3)
                // ==========================================
                state_A = md5_H(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 5], 4, 0xfffa3942);
                state_D = md5_H(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 0x8], 0xb, 0x8771f681);
                state_C = md5_H(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 0xb], 0x10, 0x6d9d6122);
                state_B = md5_H(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 0xe], 0x17, 0xfde5380c);
                // ==========================================
                // تابع المرحلة الثالثة: استكمال دالة المعالجة md5_H (Round 3)
                // ==========================================
                state_A = md5_H(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 1], 4, 0xa4beea44);
                state_D = md5_H(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 4], 0xb, 0x4bdecfa9);
                state_C = md5_H(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 0x7], 0x10, 0xf6bb4b60);
                state_B = md5_H(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 10], 0x17, 0xbebfbc70);
                state_A = md5_H(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 0xd], 4, 0x289b7ec6);
                state_D = md5_H(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 0], 0xb, 0xeaa127fa);
                state_C = md5_H(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 3], 0x10, 0xd4ef3085);
                state_B = md5_H(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 6], 0x17, 0x4881d05);
                state_A = md5_H(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 0x9], 4, 0xd9d4d039);
                state_D = md5_H(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 0xc], 0xb, 0xe6db99e5);
                state_C = md5_H(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 15], 0x10, 0x1fa27cf8);
                state_B = md5_H(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 2], 0x17, 0xc4ac5665);

                // ==========================================
                // المرحلة الرابعة: تنفيذ دالة المعالجة md5_I (Round 4)
                // ==========================================
                state_A = md5_I(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 0], 6, 0xf4292244);
                state_D = md5_I(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 0x7], 10, 0x432aff97);
                state_C = md5_I(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 0xe], 15, 0xab9423a7);
                state_B = md5_I(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 5], 0x15, 0xfc93a039);
                state_A = md5_I(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 0xc], 6, 0x655b59c3);
                state_D = md5_I(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 3], 10, 0x8f0ccc92);
                state_C = md5_I(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 10], 15, 0xffeff47d);
                state_B = md5_I(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 1], 0x15, 0x85845dd1);
                state_A = md5_I(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 0x8], 6, 0x6fa87e4f);
                state_D = md5_I(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 15], 10, 0xfe2ce6e0);
                state_C = md5_I(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 6], 15, 0xa3014314);
                state_B = md5_I(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 0xd], 0x15, 0x4e0811a1);
                state_A = md5_I(state_A, state_B, state_C, state_D, wordsArray[blockIndex + 4], 6, 0xf7537e82);
                state_D = md5_I(state_D, state_A, state_B, state_C, wordsArray[blockIndex + 0xb], 10, 0xbd3af235);
                state_C = md5_I(state_C, state_D, state_A, state_B, wordsArray[blockIndex + 2], 15, 0x2ad7d2bb);
                state_B = md5_I(state_B, state_C, state_D, state_A, wordsArray[blockIndex + 0x9], 0x15, 0xeb86d391);
...
window.updateusers = updateusers;
    ...
    window.VoicePeerConnection = VoicePeerConnection;
window.addUserToIgnore = addUserToIgnore;
window.analyzeAudioLevel = analyzeAudioLevel;
window.appendTableRow = appendTableRow;
window.buildCompressor = buildCompressor;
window.buildEmojiBoxPanel = buildEmojiBoxPanel;
window.buildJsonEditForm = buildJsonEditForm;
window.buildOscillator = buildOscillator;
window.buildTableHtmlElement = buildTableHtmlElement;
window.buildTableRowHtml = buildTableRowHtml;
window.calculateTimeAgoString = calculateTimeAgoString;
window.calculateViewportWidthDifference = calculateViewportWidthDifference;
window.checkInput = checkInput;
window.connectVoiceToUser = connectVoiceToUser;
window.decryptCommand = decryptCommand;
window.destroy = destroy;
window.dragElement = dragElement;
window.executeAjaxUpload = executeAjaxUpload;
window.executeControlPanelAction = executeControlPanelAction;
window.executeGdFingerprint = executeGdFingerprint;
window.executeGfFingerprint = executeGfFingerprint;
window.executeHashAlgorithm = executeHashAlgorithm;
window.executeSecondarySetup = executeSecondarySetup;
window.executeStealthUserSetup = executeStealthUserSetup;
window.extractBufferData = extractBufferData;
window.extractRootDomain = extractRootDomain;
window.extractYouTubeVideoId = extractYouTubeVideoId;
window.findUserByLid = findUserByLid;
window.formatLargeNumber = formatLargeNumber;
window.generateAudioFingerprint = generateAudioFingerprint;
window.generateColorShade = generateColorShade;
window.getBrowserLocalizationOptions = getBrowserLocalizationOptions;
window.getCookieValue = getCookieValue;
window.getFallbackCookieValue = getFallbackCookieValue;
window.getQueryParamValue = getQueryParamValue;
window.getSanitizedReferrer = getSanitizedReferrer;
window.getTemplateHeadHtml = getTemplateHeadHtml;
window.getUserIconPath = getUserIconPath;
window.getUsersInSpecificRoom = getUsersInSpecificRoom;
window.getv = getv;
window.handleDisconnectFallback = handleDisconnectFallback;
window.handlePrivateCallAction = handlePrivateCallAction;
window.handleWindowBeforeUnload = handleWindowBeforeUnload;
window.hl = hl;
window.initializeOfflineContext = initializeOfflineContext;
window.injectBroadcastItemToUi = injectBroadcastItemToUi;
window.inputString = inputString;
window.isUserIgnoredInList = isUserIgnoredInList;
window.loadIgnoreBlocklist = loadIgnoreBlocklist;
...
window.msgs = msgs;
window.on = on;
window.onaudioprocess = onaudioprocess;
window.onended = onended;
window.onerror = onerror;
window.onplay = onplay;
window.onprogress = onprogress;
window.onreadystatechange = onreadystatechange;
window.onunload = onunload;
window.openContextMenu = openContextMenu;
window.openFileInputSelector = openFileInputSelector;
window.openSecondaryAdminNotification = openSecondaryAdminNotification;
window.parseUserPowerString = parseUserPowerString;
window.polyfillForEach = polyfillForEach;
window.polyfillPadStart = polyfillPadStart;
window.pri = pri;
window.processRenderedAudio = processRenderedAudio;
window.removeUserFromIgnore = removeUserFromIgnore;
window.renderSelectedPowerDetails = renderSelectedPowerDetails;
window.requestMicrophonePermission = requestMicrophonePermission;
window.resetIosScroll = resetIosScroll;
window.runAutoScrollTimer = runAutoScrollTimer;
window.runTimeAgoUpdater = runTimeAgoUpdater;
window.safeAdd = safeAdd;
window.sanitizeIncomingText = sanitizeIncomingText;
window.saveIgnoreBlocklist = saveIgnoreBlocklist;
window.scrollBodyToInput = scrollBodyToInput;
window.serializeFormInputsData = serializeFormInputsData;
window.setCompressorParameter = setCompressorParameter;
window.setFallbackCookieValue = setFallbackCookieValue;
window.setupContextInstance = setupContextInstance;
window.setupIosInputFixes = setupIosInputFixes;
window.setv = setv;
window.showNotificationToast = showNotificationToast;
window.sort = sort;
...
window.time = time;
window.updateLazyImagesAndSortRooms = updateLazyImagesAndSortRooms;
window.updateOnlineUsersList = updateOnlineUsersList;
window.updatePermissionsUi = updatePermissionsUi;
window.updateRoomMicsStatus = updateRoomMicsStatus;
window.updateRoomRowInSidebarUi = updateRoomRowInSidebarUi;
window.updateUserRowInUi = updateUserRowInUi;
window.uploadAdminImage = uploadAdminImage;
window.uploadImageWithProgress = uploadImageWithProgress;

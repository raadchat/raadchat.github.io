...
if("srcObject"in var436.audio)(v438("#cp li").hide().find("a[href='#fps'],a[href=\"#acti\"+"ons"],a[href='#cp_rooms'],a[href='#logins']").parent().show(),v439.ban&&v440("#cp li").find("a[href='#bans'],a[href='#actions'],a[href='#cp_rooms"]').parent().show(),v441.setpower&&v442("#cp li").find("a[href='#powers'],a[href='#subs']").parent().show(),v443.owner&&v444("#cp li").show());
else{
...
var611<5;
var611++){
  if("HqySU"==="mGlYQ")returntrue;
  else{
    var var612=mic[var611],v613=false,v614,v615=$("#mic"+var611);
    typeof var612=="string"&&(v614=v435(var612),v615.length&&v614!=null&&(v613=true)),var612!=myid&&v615.off().attr("onclick",''),v615.attr("uid",var612||''),v613?(v615.find('.u').show(),v615.css("background-image","url("+v614.pic+')'),v615.find("img")[0].src=v616(v614),v615.find("span").text(v614.topic),var612==myid?v615.off().attr("onclick","tmic(-1);
    "):v615.off().click(function(){
...
})):(v615.find('.u').hide(),v615.css("background-image","url(imgs/mic.png)"),var612==0?"'+v626.bid+"'
});
").show().text(v627.likes||''):v615.css({
...
if(var749!=null){
  ...
  v475.cp&&($("#cp li").hide().find("a[href='#fps'],a[href='#actions'],a[href=\"#cp_ro\"+"oms"],a[href='#logins']").parent().show(),v475.ban&&$("#cp li").find("a[href='#bans'],a[href='#actions\"],a[href="#cp_rooms"]').parent().show(),v475.setpower&&$("#cp li").find("a[href='#powers'],a[href='#subs']").parent().show(),v475.owner&&$("#cp li").show());
...
p203.keyCode==13&&(p203.preventDefault(),v1025())),v1027==".tboxbc"&&(v1028=v1029,v1030(false,null,v1031.find(".tbox"))),v1032=="#tbox"&&(v1033=v1034,v1035(v1036.find(".tbox"))));
...
var1203++){
  ...
  if(var1204.lid==p250.lid)returntrue;
}returnfalse;
}var var1205={
};
function v624(p251){
